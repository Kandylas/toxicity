...
myplot<-ggplot(ebp05, aes(TEAM,GLU), colour=TEAM)
...
myplot<-ggplot(ebp05, aes(TEAM,BUN), colour=TEAM)
...
myplot<-ggplot(ebp05, aes(TEAM,CREA), colour=TEAM)
...
myplot<-ggplot(ebp05, aes(TEAM,TCHOL), colour=TEAM)
...
myplot<-ggplot(ebp05, aes(TEAM,TGL), colour=TEAM)
...
myplot<-ggplot(ebp05, aes(TEAM,ALT), colour=TEAM)
...
myplot<-ggplot(ebp05, aes(TEAM,TP), colour=TEAM)
...
myplot<-ggplot(ebp05, aes(TEAM,HCT), colour=TEAM)
...
myplot<-ggplot(ebp05, aes(TEAM,WBC), colour=TEAM)
...
qplot(TEAM, PLT, data=ebp05, geom="boxplot")

fit11<- aov(PLT~TEAM, data=ebp05)
fit11
summary(fit11)
...
m_aggr<-aggregate(ebp05$PLT, by=list(ebp05$TEAM), FUN=mean)
str
group_means<-data.frame(TEAM=m_aggr[,1], Wt=m_aggr[,2])

myplot<-ggplot(ebp05, aes(TEAM,PLT), colour=TEAM)
